/*
 * Stoatworks Labs - About window data for Databend.
 *
 * PROVISIONAL, hand-written in the shape stoatworks-backend/scripts/sync-about.py
 * generates. Databend is not yet registered in the website's projects.json, so
 * the sync cannot produce this file; once it is, `sync-about.py --only
 * databend --apply` overwrites this with the generated copy. The facts below
 * are the ones that registration will carry, so the parameter count -- which
 * depends on how many links are present -- does not change when it does.
 *
...
{
    inline constexpr auto name = "Databend";
    inline constexpr auto slug = "databend";
    inline constexpr auto hook = "The raster as a PCM stream through audio effects, for Resolume";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "";
    inline constexpr auto page = "https://stoatworks-labs.com/software/databend/";
    inline constexpr auto repo = "https://github.com/stoatworks-labs/databend";
