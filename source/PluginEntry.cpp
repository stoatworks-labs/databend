/**
	...
	`CFFGLPluginInfo` that Databend.cpp registers at static-initialisation
	...
	binary: which build it is.
		...
		strings Databend.bundle/Contents/MacOS/Databend | grep databend
*/

extern "C" const char* DatabendBuildStamp()
{
	return "databend " DATABEND_VERSION " built " __DATE__ " " __TIME__;
}
