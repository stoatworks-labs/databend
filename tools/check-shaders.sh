...
#
#   tools/check-shaders.sh [path/to/dbtest]
#
# The text compiled is what `dbtest --dump-shaders` writes: the exact strings
...
dir="$( mktemp -d )"
"$DBTEST" --dump-shaders "$dir" >/dev/null
n=0; bad=0
